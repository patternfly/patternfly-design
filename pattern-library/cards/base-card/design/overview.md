...
![Aggregate Status Card](img/aggregate-status-card.png)

[View the Aggregate Status Card Pattern](http://www.patternfly.org/pattern-library/cards/aggregate-status-card/#/api)

## Trend Card
### Small Cards
![Trend Card](img/trend-card-small-example.png)
### Large Cards
![Image of trend card](img/trend-card-large-example.png)
...
![Image of utilization bar card](img/utilization-bar-card-example-1.png)
### Left Description and Right Label
![Image of utilization bar card](img/utilization-bar-card-example-2.png)
...
![Image of utilization trend card](img/utilization-trend-card-example-1.png)
![Image of utilization trend card](img/utilization-trend-card-example-2.png)
